...
\begin{enumerate}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\setlength{\topsep}{1pt}
    ...
    \item \textbf{Architectural Compute Compensation}: We co-design downstream detection with an inverted residual decoupled head~\cite{ESODYOLO} that slashes detector parameters by $>27\%$.
\end{enumerate}
