...
\begin{enumerate}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\setlength{\topsep}{1pt}
    ...
    \item \textbf{Compute Compensation and Empirical Gains}: We integrate an ISPP head that cuts detector parameters by \textgreater27\% while largely retaining dual-evidence routing's gains; the resulting HESOD improves $\mathrm{mAP@.5}$ by 0.9/2.3\,pp and total instance recall by 3.66/3.33\,pp on UAVDT/SeaPerson.
\end{enumerate}

\begin{figure*}[t]
\centering
\includegraphics[width=0.855\textwidth]{figures/HESOD.pdf}
\vspace{-4.25mm}
