...
\label{eq:fusion}
\end{equation}
which guarantees monotonic evidence preservation ($z_{i,c} \ge z^{\mathrm{sem}}_{i,c}, z^{\mathrm{spec}}_{i,c}$), functioning as an OR gate where neither branch can suppress candidate cues. Cells with priority $s_i > \tau$ are clustered into bounding patches $\mathcal{P}$ for downstream detection.
