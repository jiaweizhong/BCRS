...
\name{Jiawei Zhong$^{1,\dagger}$\thanks{Source code at \url{https://github.com/deepsota-ai/HESOD}.}\thanks{These authors contributed equally to this work.}, Sicheng Xu$^{2,\dagger}$, Dandan Liu$^{3}$, Kang An$^{2}$, Hui Zhang$^{2}$\sthanks{Corresponding author.}}
\address{
