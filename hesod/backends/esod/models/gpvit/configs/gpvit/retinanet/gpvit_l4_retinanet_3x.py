...
checkpoint_url = "https://github.com/ChenhongyiYang/GPViT/releases/download/v0.0.1/gpvit_l4_in1k_300e.pth"
embed_dims = 624
model = dict(
    type="RetinaNet",
    backbone=dict(
...
data = dict(samples_per_gpu=2, workers_per_gpu=2, train=dict(pipeline=train_pipeline))
...
work_dir = "work_dirs/gpvit_l4_retinanet_3x"
