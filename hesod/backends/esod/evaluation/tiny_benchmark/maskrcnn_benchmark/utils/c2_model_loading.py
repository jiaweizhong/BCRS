...
@C2_FORMAT_LOADER.register("R-50-C2")  # add by hui
@C2_FORMAT_LOADER.register("R-50-C3")  # add by hui
...
@C2_FORMAT_LOADER.register("R-18-FPN")  # add by hui
