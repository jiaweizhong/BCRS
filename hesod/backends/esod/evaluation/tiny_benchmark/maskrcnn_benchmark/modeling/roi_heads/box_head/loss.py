...
class FastRCNNLossComputation(object):
    ...
    def __call__(self, class_logits, box_regression):
        ...
        if self.ohem_loss is None:
            ...
            classification_loss = self.ohem_loss(class_logits, labels)
        # ###################################################################################
        ...
        #             print('fasterx', labels.numel())
        else:
            box_loss = box_loss / self.ohem_loss.get_sample_count()
        #             print('faster', self.ohem_loss.sample_count)
        ####################################################################################
